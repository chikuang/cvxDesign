#' Compute an A-optimal approximate design on a finite candidate set
#'
...
#'
#' @return An object of class "cvx_a_design" and "cvx_design".
#' @export
calc_Aopt <- function(u,
  ...
  class(out) <- c("cvx_a_design", "cvx_design")
  out
}
